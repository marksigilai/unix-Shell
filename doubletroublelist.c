...
void swap(struct node* ref1, struct node* ref2) {
     ...
     */
    /* Your code here */
    struct node* ref1next = next(ref1);
    struct node* ref1prev = prev(ref1);
    struct node* ref2next = next(ref2);
    struct node* ref2prev = prev(ref2);

    if((ref1->prev == NULL) || (ref2->next == NULL) || (ref1->next == NULL) || (ref2->prev == NULL)) {
        ref1->next = ref2next;
        ref2->next = ref1next;
        ref1->prev = ref2prev;
        ref2->prev = ref1prev;
        ...
        if((ref2next != ref1) && (ref1next != ref2)){
            ref1next->prev = ref2;
            ref2prev->next = ref1;
        }
...
struct node* shift_left(struct node* ref, int n) {
    ...
    int i;
    struct node* head = begin(ref);
    struct node* refnext = next(ref);
    struct node* refprev = prev(ref);
